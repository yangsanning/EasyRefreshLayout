package ysn.com.view.jackrefreshlayout;
...
import ysn.com.view.jackrefreshlayout.constant.RefreshState;
import ysn.com.view.jackrefreshlayout.constant.RefreshTag;
...
import ysn.com.view.jackrefreshlayout.utils.AnimUtils;

/**
 * @Author yangsanning
 * @ClassName JackRefreshLayout
 * @Description 刷新布局
 * @Date 2020/2/12
 * @History 2020/2/12 author: description:
 */
public class JackRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public JackRefreshLayout(Context context) {
        this(context, null);
    }

    public JackRefreshLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JackRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public JackRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     */
    public JackRefreshLayout addHeadView(@NonNull View headView) {
     ...
     */
    public JackRefreshLayout addFootView(@NonNull View footView) {
     ...
     * 设置刷新加载组合监听
     */
    public JackRefreshLayout setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener onRefreshLoadMoreListener) {
        this.onRefreshLoadMoreListener = onRefreshLoadMoreListener;
        return this;
    }

    public JackRefreshLayout setOnChildScrollUpCallback(@Nullable OnChildScrollUpCallback onChildScrollUpCallback) {
    ...
    public interface OnChildScrollUpCallback {
         ...
         * 是否允许子视图滚动
         */
        boolean canChildScrollUp(JackRefreshLayout parent, @Nullable View child);
    }
